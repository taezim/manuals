...
public class MemberRepositoryImpl implements MemberRepository{
	...
	public void createNewMember(Member member) {
		...
		template.update(SQL, member.getMemberId(), member.getName(), member.getPassword(), member.getBirth(),member.getTeam(),member.getInjury(), member.getAddress(), member.getClassId(), member.getTeacherId(), member.getPersonalRecord(), member.getSex(), member.getFileName());
