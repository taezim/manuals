...
<c:forEach var="hospital" items="${hospitalList}">
    ...
    <div>
      ...
      <p><a href="<c:url value="/hospitals/hospital?id=${hospital.hospitalId}"/>"class="btn btn-secondary" role="button">상세정보 &raquo;</a>
       </div>
       <hr>
       	<form:form name="addWish" method="put">
			<p><a href="javascript:addToWish('../wish/add/${hospital.hospitalId}')" class="btn btn-primary">관심 등록 &raquo;</a>
