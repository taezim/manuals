...
<form:input path="reservDate" placeholder="Reservation Date" id="datepicker" type="text" /><br/>
<form:input path="startTime" placeholder="Start Time" type="text" /><br/>
<form:input path="endTime" placeholder="End Time" type="text" /><br/>
