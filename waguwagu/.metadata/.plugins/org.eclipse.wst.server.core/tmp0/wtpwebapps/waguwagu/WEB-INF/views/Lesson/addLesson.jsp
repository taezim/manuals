...
<body>
	...
	<form:form modelAttribute="addLesson">
		...
		<label for="startDate">수업 시작일:</label><form:input type="date" id="startDate" path="startDate" placeholder="yyyy-MM-dd" />
		<label for="endDate">수업 종료일:</label><form:input type="date" id="endDate" path="endDate" placeholder="yyyy-MM-dd" />
