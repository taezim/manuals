...
<div class="col-md-4 container">
	<form:form modelAttribute="addLesson" action="./update?id=${lesson.classId}">
		...
		<label for="startDate">수업 시작일:</label>
			<form:input type="date" id="startDate" path="startDate" value="${lesson.startDate}" />
		<label for="endDate">수업 종료일:</label>
		<form:input type="date" id="endDate" path="endDate"  value="${lesson.endDate}"/> <!-- 일단은 placeholder 지움 -->
