						    ...
						    <div class="review_item">
						      <div class="media">
						        ...
						        <div class="media-body">
						          <h4 class="number" style="cursor:pointer;">${productqna.number}</h4>
							    ...
							    <form:form modelAttribute="productupdateqna" method="post" action="/QnA240228_view_after/productquestion/productupdate" id="contactForm" novalidate="novalidate">
							        <div class="col-md-12">
							            <div class="form-group">
							                ...
							                <input type="text"  class="form-control" id="number" name="number" readonly="true" value="${product123.number}"/>
							            </div>
							        </div>
							        <div class="col-md-12">
							            <div class="form-group">
							        ...
							        <div class="col-md-12">
							            <div class="form-group">
							                ...
							                <input type="date"  class="form-control" id="date" name="date" value="${product123.date}"/>
							            </div>
							        </div>
							        <div class="col-md-12">
							            <div class="form-group">
  ...
  var editButtons = document.getElementsByClassName('edit_buttons');
    for (var i = 0; i < editButtons.length; i++) {
        editButtons[i].addEventListener('click', function(e) {
            ...
            form.action = '/productquestion/productupdate'; // 수정 처리를 담당하는 컨트롤러 경로

            // hidden 필드 추가 - 수정할 댓글의 ID 전달
            var productIdInput = document.createElement('input');
            productIdInput.type = 'hidden';
            productIdInput.name = 'productid'; // 컨트롤러에서 사용할 파라미터명
