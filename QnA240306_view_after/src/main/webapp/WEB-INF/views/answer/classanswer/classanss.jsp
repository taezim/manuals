...
<table cellspacing="0" border="1" summary="게시판의 글제목 리스트" class="tbl_type">
    ...
    <td class="title"><a href="./classanswers/classanswer?an=${answer123.classid}">${answer123.answercontent}</a></td>
    ...
    <br>
    <div class="divbox">
    <a href="<c:url value="/classanswers/classadd" />" class="btn btn-outline-secondary">글쓰기</a>
    <!-- //UI Object -->
   	</div>
</body>
</html>