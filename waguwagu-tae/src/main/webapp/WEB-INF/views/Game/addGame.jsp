			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>게임등록</h3>
						<form:form class="row login_form" id="contactForm" modelAttribute="addGame" enctype="multipart/form-data">
							<div class="col-md-12 form-group">
								<form:input path="teamId1" class="form-control" id="name" name="name" placeholder="팀아이디" onfocus="this.placeholder = ''" onblur="this.placeholder = '팀아이디'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="teamName1" type="text" class="form-control" id="name" name="name" placeholder="팀명" onfocus="this.placeholder = ''" onblur="this.placeholder = '팀명'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input type="date" path="date" class="form-control" id="name" name="name" placeholder="경기 날짜" onfocus="this.placeholder = ''" onblur="this.placeholder = '경기 날짜'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="userId" type="text" class="form-control" id="Id" name="memberId" value="${memberId}" placeholder="예약자 아이디" onfocus="this.placeholder = ''" onblur="this.placeholder = '예약자 아이디'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="userName" type="text" class="form-control" id="name" name="name" placeholder="예약자 이름" onfocus="this.placeholder = ''" onblur="this.placeholder = '예약자 이름'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="userNumber" type="text" class="form-control" id="name" name="name" placeholder="전화번호" onfocus="this.placeholder = ''" onblur="this.placeholder = '전화번호'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="stadium" type="text" class="form-control" id="name" name="name" placeholder="경기장" onfocus="this.placeholder = ''" onblur="this.placeholder = '경기장'" />
							</div>
							<div class="col-md-12 form-group">
