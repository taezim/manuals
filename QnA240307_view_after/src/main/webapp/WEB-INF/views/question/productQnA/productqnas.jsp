					...
					<div class="rowmappertow">
						  ...
						  <c:forEach items="${productqnaList}" var="productqna">
						    <div class="review_item">
						      ...
						      <div class="edit_delete_buttons" style="display:none;">
						        <a href="#" class="edit_buttons" data-productid="${productqna.productid}">수정하기</a>
					 ...
					 <div class="col-lg-6">
						...
						<div class="col-lg-6">
							...
							<form:form modelAttribute="productplus" method="post" action="/QnA240228_view_after/productquestion/add" id="contactForm" novalidate="novalidate">
							    <div class="col-md-12">
							...
							<div id="editFormWrapper" style="display:none;">
							    <form:form modelAttribute="productupdateqna" method="post" action="/QnA240228_view_after/productquestion/productupdate" id="contactForm" novalidate="novalidate">
							        <div class="col-md-12">
							            <div class="form-group">
							                <!-- productupdateqna 객체의 number 필드를 바인딩합니다. -->
							                <input type="text"  class="form-control" id="number" name="number" readonly="true" value="${product123.name}"/>
							            </div>
							        </div>
							        <div class="col-md-12">
							            <div class="form-group">
							                <!-- productupdateqna 객체의 email 필드를 바인딩합니다. -->
							                <input type="email"  class="form-control" id="email" name="email" value="${product123.email}"/>
							            </div>
							        </div>
							        <div class="col-md-12">
							            <div class="form-group">
							                <!-- productupdateqna 객체의 date 필드를 바인딩합니다. -->
							                <input type="text"  class="form-control" id="productid" name="productid" value="${product123.productid}"/>
							            </div>
							        </div>
							        <div class="col-md-12">
							            <div class="form-group">
							                <!-- productupdateqna 객체의 content 필드를 바인딩합니다. -->
							                <textarea class="form-control"  name="content" id="content" rows="1">${product123.content}</textarea>
							            </div>
							        </div>
							        <div class="col-md-12 text-right">
							            <!-- "등록" 버튼을 클릭하면 productupdateqna 객체를 서버로 전송합니다. -->
...
/* 3개 글 보기 */
  ...
  function deleteConfirm(productid) {
	    if (confirm("삭제하시겠습니까?") == true) {
	        // 직접 URL을 생성하여 이동합니다.
	        location.href = "/QnA240228_view_after/productquestion/productdelete?productid=" + productid;
	    } else {
	        return;
	    }
	}
    ...
    editButtons[i].addEventListener('click', function(e) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                document.getElementById('content').value = productData.content;

                // 수정 폼을 보이도록 설정
                document.getElementById('editFormWrapper').style.display = 'block';
            }
        };
        xhr.open('GET', '/QnA240228_view_after/productquestion/productupdate?productid=' + productId, true);
        xhr.send();
    });
} */
</script>
...
$(document).ready(function(){
	  $(".edit_buttons").click(function(e){
	    e.preventDefault();
	    var productid = $(this).attr('data-productid');
	    $.ajax({
	      url: "/QnA240228_view_after/productquestion/productupdate",
	      type: 'POST',
